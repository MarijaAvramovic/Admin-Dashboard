...
The project has HTML elements  sidebar, header and main-content containers.
 Help provided with Grid properties.
Also I added child elements under the parent elements in the HTML and styled them with grid as well. Tried to keep making grid containers within grid containers.
